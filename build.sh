...
convert out/tmp.1-base-or8.png out/tmp.1-cardback-or8.png -geometry +161+495 -composite -strip out/1-composite-or8.png

optipng -q out/1-*8.png
...
convert out/tmp.2-base-a-or8.png out/tmp.2-reload-a-or8.png -geometry +319+495 -composite -strip out/2-composite-a-or8.png
...
pngquant -s1 --nofs 66 < reload.png > out/tmp.2-reload-b-or8.png
convert out/tmp.2-base-b-or8.png out/tmp.2-reload-b-or8.png -geometry +319+495 -composite -strip out/2-composite-b-or8.png

optipng -q out/2-*8.png
